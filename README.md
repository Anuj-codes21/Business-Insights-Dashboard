...
## Power BI Mobile Sales Data Analysis Dashboard-
 
This project showcases an interactive Power BI dashboard designed to analyze and visualize data in a clear, insightful, and user-friendly way.
The dashboard helps stakeholders understand key trends, performance metrics, and patterns through dynamic visuals and filters. 

## Project Objective
The main objective of this project is to analyze mobile sales data and create an interactive dashboard to track performance across cities, brands, payment methods, and time periods.
...
## Final Conclusion
The dashboard provides a clear and interactive overview of mobile sales performance. It helps identify top-performing cities, brands, and time periods while highlighting customer behavior and payment preferences.
This analysis can support business decisions such as inventory planning, marketing strategies, and sales optimization to improve overall performance.
